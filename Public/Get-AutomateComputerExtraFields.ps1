function Get-AutomateComputerExtraFields {
    <#
  .SYNOPSIS
  ...
  .EXAMPLE
      Get-AutomateComputerExtraFields -Computer 102
  .EXAMPLE
      Get-AutomateClientExtraFields -Computer 102 -Title 'PatchingSchedule' -ValueOnly $true
  #>
  ...
  $Params = @{
      Endpoint = "computers/$Computer/extrafields"
      Page = 1
  }
